<div>
    ...
    <div class="relative">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div class="opacity-60 absolute inset-0 bg-gradient-to-r from-purple-800 to-indigo-700 mix-blend-multiply "></div>
                <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-5xl">
                        <span class="block text-white">NAUTICA</span>
                        <span class="block text-indigo-200">PERTH'S PREMIER CRUISE AND PARTY VESSEL...AWAITS</span>
                    </h1>
                    <p class="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">Reserve your perfect boat today!</p>
    ...
    <div class="bg-gray-100">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm font-semibold uppercase text-gray-500 tracking-wide">Trusted by over 5 very
            ...
            <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                    <div>
                        ...
                        <div class="mt-6">
                            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Stay on top of customer
                                support
                            </h2>
                            <p class="mt-4 text-lg text-gray-500">Sit back and relax during the day, taking in the scenic views of the Swan River, while the DJ plays your favourite music and dance with your friends.
                            </p>
                        </div>
                    </div>
                    <div class="mt-8 border-t border-gray-200 pt-6">
                        <blockquote>
                            <div>
                                <p class="text-base text-gray-500">&ldquo;Had my hens night last night and nautica was the best!! The skipper and deckhand were awesome and the dj played the best music and had us girls dancing all night!!! Thanks guys. Will recommend you to everyone 🙂&rdquo;</p>
                            </div>
                            <footer class="mt-3">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="text-base font-medium text-gray-700">Mila Cohen
                                    </div>
                                </div>
                            </footer>
                        </blockquote>
                ...
                <div class="mt-12 sm:mt-16 lg:mt-0">
                    <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                        <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                            src="https://img1.wsimg.com/isteam/ip/3e8e1dff-1a47-4935-81d0-0ee3c4225ff2/6c3cdc4846f1d4fe57cbbbb1660dd1b3.jpg"
                    ...
                    <div>
                        ...
                        <div class="mt-6">
                            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Better understand your
                                customers</h2>
                            <p class="mt-4 text-lg text-gray-500">During the twilight cruise, enjoy the sun setting in the West. Let the DJ turn up the music of your favourite songs and turn Nautica into a floating night club, with laser lights and smoke machine. Guest can dance the night away while gazing at Perth’s amazing city lights while the crew cooks your dinner.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
                    <div class="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                        <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none"
                            src="https://img1.wsimg.com/isteam/ip/3e8e1dff-1a47-4935-81d0-0ee3c4225ff2/22f7922fbfa5887d302f98632c3f8b5d.jpg/:/rs=w:1300,h:800"
    ...
    {{-- <div class="bg-gradient-to-r from-purple-800 to-indigo-700">
        <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
            ...
            <p class="mt-4 max-w-3xl text-lg text-purple-200">Ac tincidunt sapien vehicula erat auctor pellentesque
                rhoncus.
                Et magna sit morbi lobortis. Blandit aliquam sit nisl euismod mattis in.</p>
            <div
                ...
                <div>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-base text-purple-200">Ac tincidunt sapien vehicula erat auctor pellentesque
            ...
            <div class="h-full w-full xl:grid xl:grid-cols-2">
                <div class="h-full xl:relative xl:col-start-2">
                    <img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0"
                        src="https://scontent.fper6-1.fna.fbcdn.net/v/t31.18172-8/29983148_991397914356888_3317238747130083975_o.jpg?_nc_cat=100&ccb=1-7&_nc_sid=e3f864&_nc_ohc=w0ujvs7m3xAAX8704SN&_nc_ht=scontent.fper6-1.fna&oh=00_AT8yJGs-6QdR-wfkjpMvWe6zMhy5mzPsqrOtYYVItSHlXQ&oe=62B4D710"
        ...
        <div
            ...
            <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                <h2 class="text-sm font-semibold tracking-wide uppercase">
                    <span class="bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">Facts</span>
                </h2>
                <p class="mt-3 text-3xl font-extrabold text-white">
                    Come aboard Nautica Charters to celebrate a day or night out with a difference. </p>
                </p>
                <p class="mt-5 text-lg text-gray-300">
                    Come aboard Nautica Charters to celebrate a day or night out with a difference.
                </p>
                <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                    <p>
                        <span class="block text-2xl font-bold text-white">1000+</span>
                        <span class="mt-1 block text-base text-gray-300"><span
                                class="font-medium text-white">People</span> have trusted & used Nautica.</span>
                    </p>

                    <p>
                        <span class="block text-2xl font-bold text-white">12</span>
                        <span class="mt-1 block text-base text-gray-300"><span
                                class="font-medium text-white">Locations</span> covered.</span>
                    </p>
                    ...
                    <p>
                        ...
                        <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Customer
                                satisfaction</span>, providing the best experience for our customers.</span>
                    </p>

                    <p>
                        <span class="block text-2xl font-bold text-white">32</span>
                        <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">Passengers</span> fit on this boat.</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <span
                    ...
                    in touch for the best experience in your life.</span>
            </h2>
